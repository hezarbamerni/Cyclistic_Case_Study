...
May21$month <- month.name[as.numeric(May21$month)]
...
```{r}
May21 <- subset (May21, ride_length > 59)
```
...
```{r}
May21$day_of_week <- ordered(May21$day_of_week, levels=c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"))
```
