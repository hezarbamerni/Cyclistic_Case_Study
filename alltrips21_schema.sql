...
--INSERT ALL TABLES FROM JAN21 THROUGH DEC21 INTO ONE TABLE, ALLTRIPS21
...
--Calculates the total number of bike trips, the number of unique trips, and the average trip duration (excluding rows with missing or invalid data, and trips with duration less than 59 seconds).
SELECT 
    COUNT(*) AS total_trips,
    AVG(TIMESTAMPDIFF(SECOND, started_at, ended_at)) AS average_duration
FROM 
    alltrips21
WHERE 
	ride_id IS NOT NULL
